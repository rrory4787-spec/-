    ...
    <div className="flex-1 bg-[#0A0A0A] p-4 pb-28 md:p-6 md:pb-12 flex flex-col gap-8 overflow-y-auto max-w-4xl mx-auto w-full">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="w-1.5 sm:w-2 h-6 sm:h-8 bg-blue-500 rounded-full" />
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white tracking-tighter">أكاديمية الحيتان</h2>
        </div>
